...
import { getTourBySlug, type LocalizedString } from "@/data/tours";
import olonNuurLogo from "@assets/olon_nuur_nobg.png";

const t = (str: LocalizedString, lang: "mn" | "ko") => str[lang];
...
const labels = {
  mn: {
    ...
    bookHint: "Та доорх холбоосоор бидэнтэй холбогдож, өөрт тохирсон огноогоор захиалгаа өгөөрэй.",
  ...
  ko: {
    ...
    departures: "특별 출발 일정",
    bookCta: "예약 문의",
    bookHint: "아래 연락처로 문의 주시면 원하시는 날짜로 예약을 도와드립니다.",
    notReady: "곧 공개 예정",
    ...
    <nav className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-stone-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <img src={olonNuurLogo} alt="Olon Nuur Travel" className="h-14 w-auto" />
        </Link>
...
export default function TourDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 flex flex-col">
      ...
      {/* Hero */}
      <section className="relative h-[60vh] min-h-[420px] flex items-end overflow-hidden bg-stone-950">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-600/15 border border-amber-500/25 mb-4">
            <Bird className="h-3.5 w-3.5 text-amber-300" />
            <span className="text-xs font-semibold text-amber-200 tracking-widest uppercase">
              Olon Nuur Travel
            </span>
          </div>
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-3 max-w-3xl">
            {t(tour.hero.title, lang)}
          </h1>
          <p className="text-base md:text-lg text-stone-300 max-w-2xl">
          ...
          <section className="max-w-7xl mx-auto px-6 -mt-16 relative z-20">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
              {[
                ...
                { icon: MapPin, label: L.route, value: t(tour.overview.route, lang) },
              ].map((item) => (
                <Card key={item.label} className="bg-white border-stone-200 shadow-lg">
                  <CardContent className="p-4 md:p-5">
                    ...
                    <p className="text-sm md:text-base font-medium text-stone-900 leading-snug">
                      {item.value}
                    </p>
                  </CardContent>
                </Card>
          ...
          <section className="bg-white border-y border-stone-200 py-16">
            <div className="max-w-5xl mx-auto px-6">
              <div className="flex items-center gap-3 mb-10">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-stone-900">{L.schedule}</h2>
              </div>
                    ...
                    >
                      ...
                      <dl className="space-y-2 text-sm mb-5">
                        ...
                        <div className="flex gap-2">
                          ...
                          <span className="text-stone-300">{t(dep.route, lang)}</span>
                        </div>
                      </dl>
